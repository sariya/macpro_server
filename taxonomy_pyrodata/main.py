...
def print_help():
    ...
    print "\t\t main.py -c <confidence> -n <run_name> -r <rdp_output> -t <genus|species>"
...
#{
    ...
    print_populated_matrx(taxnmy_matrx_counts,taxonomy_dict,sample_names_dict,
                          _temp_dict['run_name'],_temp_dict['conf'],_temp_dict['type'])
...
if __name__=="__main__":
    ...
    if not args_dict['type'] in ['genus','species']:
        ...
        sys.exit()
    #--if check ends for type: spcies and genus value
